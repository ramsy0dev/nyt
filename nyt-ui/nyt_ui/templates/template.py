...
from nyt_ui.components.sidebar import sidebar
from typing import Callable

import reflex as rx

import nyt_ui.constant as constant
        ...
        rx.menu.root(
            ...
            rx.menu.content(
                *[
                ...
                rx.menu.separator(),
                menu_item_link("About", constant.GITHUB),
                menu_item_link("Contact", f"mailto:{constant.AUTHOR}@gmail.com"),
            ),
        ),
        position="fixed",
        right="2em",
